...
function generateSeedData() {
    ...
    function findDistrict(stateLgd, districtName) {
    ...
    const projectTemplates = [
        ...
        },
        {
            ...
            description: 'Greenfield airport in Panvel Taluka, Raigad district. Core area spans 1,160 hectares across Ulwe and Kundevahal. Displaced families resettled at Pushpak Nagar near Ulwe under a comprehensive 22.5% developed land compensation package.',
            type: 'AIRPORT',
            ...
            villages: ['Targhar', 'Kundevahal', 'Ulwe', 'Kopar', 'Owale', 'Kombadbhuje'],
            centerCoord: [73.072, 18.990],
        ...
        // Uttar Pradesh
        {
            ...
            description: 'Acquisition of 1,334 hectares for India\'s largest greenfield airport. Phase 1 officially inaugurated with commercial operations on Runway 28/10.',
            type: 'AIRPORT',
            ...
            villages: ['Rohi', 'Ranhera', 'Parohi', 'Kishorpur', 'Dayanatpur', 'Banwaribas'],
            centerCoord: [77.555, 28.155],
        ...
        },
        {
            ...
            districtHints: ['Gautam Buddha Nagar'],
            villages: ['Dayanatpur', 'Kishorpur', 'Ramner', 'Banwaribas', 'Thora', 'Bhartu'],
            centerCoord: [77.585, 28.125],
        ...
        },
        {
            ...
            villages: ['Chand Sarai', 'Gosainganj', 'Haidargarh', 'Kurebhar', 'Dostpur', 'Mohammadabad'],
            centerCoord: [82.200, 26.250],
        ...
        // Madhya Pradesh
        {
            ...
            description: 'National river interlinking priority project transferring surplus water from Ken river to Betwa basin via Daudhan Dam.',
            type: 'IRRIGATION',
            ...
            villages: ['Daudhan', 'Paldohan', 'Kharani', 'Menari', 'Basata', 'Bhadoha'],
            centerCoord: [79.880, 24.620],
        ...
        // Karnataka
        {
            ...
            villages: ['Hennur', 'Avalahalli', 'Kallubalu', 'Varthur', 'Madavara', 'Kogilu'],
            centerCoord: [77.620, 13.010],
        ...
        // Gujarat
        {
            ...
            villages: ['Makarpura', 'Padra', 'Ankleshwar', 'Sachin', 'Udhna', 'Sanjan'],
            centerCoord: [73.200, 22.300],
        ...
        // West Bengal
        {
            ...
            villages: ['Dankuni', 'Janai', 'Begampur', 'Singur', 'Mogra', 'Shaktigarh'],
            centerCoord: [88.300, 22.680],
            startDate: '2008-01-01',
        ...
        // Tamil Nadu
        {
            ...
            villages: ['Madhavaram', 'Chetpet', 'Nungambakkam', 'Adyar', 'Sholinganallur', 'SIPCOT'],
            centerCoord: [80.240, 13.060],
        ...
        },
        {
            ...
            villages: ['Sulur Aerospace Park', 'Varapatti', 'Irugur', 'Pappampatti', 'Karamadai', 'Vadapalanji'],
            centerCoord: [77.120, 11.020],
        ...
        // Rajasthan
        {
            ...
            villages: ['Bhadla Solar Grid', 'Bap Sector', 'Nawa', 'Phalodi North', 'Chak 4-B', 'Rohina'],
            centerCoord: [71.915, 27.538],
        ...
        // Jammu & Kashmir
        {
            ...
            villages: ['Kauri', 'Bakkal', 'Dugga', 'Sawalkote', 'Sumber', 'Banihal'],
            centerCoord: [74.880, 33.150],
        ...
        // Bihar
        {
            ...
            districtHints: ['Gaya'],
            villages: ['Dobhi Industrial Node', 'Barachatti', 'Bodhkata', 'Sherghati', 'Kothwara', 'Bodh Gaya'],
            centerCoord: [84.950, 24.580],
        ...
        // Haryana
        {
            ...
            villages: ['Manesar Interchange', 'Badli', 'Pachgaon', 'Tauru', 'Kharkhoda', 'Mandothi'],
            centerCoord: [76.920, 28.350],
        ...
        },
        {
            ...
            villages: ['Jind Central Node', 'Julana', 'Safidon', 'Kaithal', 'Guhla', 'Jasaur Kheri'],
            centerCoord: [76.310, 29.320],
        ...
        // Punjab
        {
            ...
            villages: ['Nakodar', 'Nurmahal', 'Shahkot', 'Sultanpur Lodhi', 'Malerkotla', 'Dhariwal'],
            centerCoord: [75.470, 31.130],
        ...
        // Himachal Pradesh
        {
            ...
            villages: ['Mandi Alignment', 'Sundernagar', 'Pandoh', 'Kullu Valley', 'Darcha', 'Upshi'],
            centerCoord: [76.930, 31.710],
        ...
        // Uttarakhand
        {
            ...
            villages: ['Devprayag Confluence', 'Shivpuri', 'Gullad', 'Maletha', 'Srinagar Garhwal', 'Gauchar'],
            centerCoord: [78.600, 30.150],
        ...
        },
        {
            ...
            villages: ['Rudraprayag Valley', 'Sonprayag', 'Dharasu Bend', 'Karnaprayag', 'Joshimath', 'Pandukeshwar'],
            centerCoord: [79.150, 30.550],
        ...
        // Andhra Pradesh
        {
            ...
            villages: ['Velagapudi Seed Core', 'Rayapudi', 'Thullur', 'Uddandarayunipalem', 'Mandadam', 'Inavolu'],
            centerCoord: [80.510, 16.540],
        ...
        },
        {
            ...
            villages: ['Polavaram Spillway', 'Ramayyapet', 'Singanapalli', 'Chegondapalli', 'Pattiseema', 'Kukunoor'],
            centerCoord: [81.655, 17.258],
        ...
        // Telangana
        {
            ...
            villages: ['Mucherla Hub', 'Medipally', 'Yacharam', 'Meerkhanpet', 'Kandukur', 'Karkalpahad'],
            centerCoord: [78.585, 17.042],
        ...
        },
        {
            ...
            villages: ['Toopran Junction', 'Narsapur', 'Gajwel', 'Pragnapur', 'Jagdevpur', 'Bhongir'],
            centerCoord: [78.480, 17.880],
        ...
        // Kerala
        {
            ...
            villages: ['Vizhinjam Port Basin', 'Mullur', 'Kottukal', 'Venganoor', 'Karimkulam', 'Chowara'],
            centerCoord: [77.002, 8.375],
        ...
        },
        {
            ...
            villages: ['Kakkanad InfoPark', 'Palarivattom', 'Vazhakkala', 'Padamughal', 'JLN Stadium', 'Chittethukara'],
            centerCoord: [76.340, 10.010],
        ...
        // Odisha
        {
            ...
            villages: ['Jhumpura Steel Zone', 'Banspal', 'Champua', 'Patna Node', 'Ghatgaon', 'Keonjhar Sadar'],
            centerCoord: [85.585, 21.625],
        ...
        },
        {
            ...
            villages: ['Paradip Western Dock', 'Balitutha', 'Kujang Berth', 'Atharbanki', 'Sandhakud', 'Nuagarh'],
            centerCoord: [86.672, 20.265],
        ...
        // Jharkhand
        {
            ...
            villages: ['Dhurwa Smart Core', 'Hatma', 'Namkum Ring Node', 'Kanke Loop', 'Tupudana', 'Argora'],
            centerCoord: [85.290, 23.310],
        ...
        // Chhattisgarh
        {
            ...
            villages: ['Raipur Central Station', 'Tatibandh', 'Kumhari Transit', 'Charoda', 'Bhilai Powerhouse', 'Durg Terminal'],
            centerCoord: [81.630, 21.250],
        ...
        // Goa
        {
            ...
            villages: ['Mopa Plateau Runway', 'Varconda', 'Casarvarnem', 'Chandel', 'Uguem', 'Pernem'],
            centerCoord: [73.865, 15.750],
        ...
        // Delhi
        {
            ...
            villages: ['RK Ashram Marg', 'Nabi Karim', 'Sadar Bazar', 'Majlis Park', 'Maujpur', 'Tughlakabad'],
            centerCoord: [77.215, 28.625],
        ...
        // Assam
        {
            ...
            villages: ['Kuruwa Bridge Node', 'Baihata Chariali', 'Narengi', 'Sonapur Corridor', 'Khanapara', 'Jalukbari'],
            centerCoord: [91.850, 26.230],
        ...
        // Arunachal Pradesh
        {
            ...
            villages: ['Sela Pass Tunnel Portal', 'Baisakhi', 'Nuraranang', 'Senge', 'Jaswantgarh', 'Jang'],
            centerCoord: [92.103, 27.505],
        ...
        // Manipur
        {
            ...
            villages: ['Kakching Sector', 'Thoubal', 'Pallel Ghat', 'Tengnoupal Ridge', 'Shenam Pass', 'Moreh Gate'],
            centerCoord: [93.980, 24.480],
        ...
        // Meghalaya
        {
            ...
            villages: ['Upper Shillong Bypass', 'Umiam Link', 'Mawmih', 'Mawngap', 'Mylliem', 'Pomlakrai'],
            centerCoord: [91.820, 25.540],
        ...
        // Nagaland
        {
            ...
            villages: ['Medziphema Gorge', 'Chumukedima Gate', 'Piphema', 'Peducha', 'Zubza Valley', 'Kohima Checkpost'],
            centerCoord: [93.850, 25.750],
        ...
        // Mizoram
        {
            ...
            villages: ['Tanhril Ridge', 'Sairang Junction', 'Durtlang West', 'Melthum', 'Falkawn Link', 'Kulikawn'],
            centerCoord: [92.680, 23.730],
        ...
        // Tripura
        {
            ...
            villages: ['Nischintapur Rail Yard', 'Badharghat', 'Gangasagar Sector', 'Ramnagar Border', 'Akhaura Link', 'Lichubagan'],
            centerCoord: [91.248, 23.832],
        ...
        // Sikkim
        {
            ...
            villages: ['Teesta Bazar Gorge', 'Sevoke Junction', 'Riyang Portal', 'Melli Station', 'Singtam Portal', 'Rangpo Border'],
            centerCoord: [88.498, 27.058],
        ...
        // Chandigarh
        {
            ...
            villages: ['Siswan Expressway Sector', 'Manimajra Outer', 'Kurali Bypass', 'Baddi Industrial Gate', 'Barotiwala Link', 'Majra'],
            centerCoord: [76.730, 30.850],
        ...
        // Puducherry
        {
            ...
            villages: ['Uppalam Port Basin', 'Thengaithittu Berth', 'Ariankuppam River Mouth', 'Villianur Node', 'Mudaliarpet', 'Dubrayapet'],
            centerCoord: [79.832, 11.918],
        ...
        // Andaman & Nicobar
        {
            ...
            villages: ['Veer Savarkar Runway', 'INS Utkrosh Enclave', 'Lamba Line', 'Dollygunj Airfield', 'Garacharma', 'Bhatubasti'],
            centerCoord: [92.730, 11.641],
        ...
        // Ladakh
        {
            ...
            villages: ['Baltal West Portal', 'Minamarg East Portal', 'Sonamarg Outflow', 'Zoji La Ridge', 'Gumri', 'Matayan'],
            centerCoord: [75.500, 34.285],
            startDate: '2020-10-15',
        ...
        // Lakshadweep
        {
            ...
            villages: ['Agatti Island Airstrip', 'Southern Lagoon Runway', 'Agatti North Village', 'Minicoy Airstrip Site', 'Kalpeni Berth', 'Kavaratti Head'],
            centerCoord: [72.176, 10.824],
        ...
        // Dadra & Nagar Haveli and Daman & Diu
        {
            ...
            villages: ['Naroli Industrial Corridor', 'Khadoli Bypass', 'Kachigam', 'Daman Coastal Jetty', 'Marwad Link', 'Silvassa Town'],
            centerCoord: [72.980, 20.270],
